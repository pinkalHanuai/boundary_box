...
$removeBtn.addEventListener("click", removeLastRectangle);

const $clearBtn = document.querySelector("#clear-btn");
$clearBtn.addEventListener("click", clearRectangles);
...
function removeLastRectangle() {
  rectangles.pop(); // Remove last rectangle from array
  redraw(); // Redraw remaining rectangles
}
